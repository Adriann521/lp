...
var i 	= 'LastPlay';    	// Issuer (Software organization who issues the token)
var s 	= 'admin@lastplay.com';	// Subject (intended user of the token)
var a 	= 'https://lastplay.tv';	// Audience (Domain within which this token will live and function)
