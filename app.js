      ...
      if (err) {
        ...
        sgMail
          ...
          .then(response => {
            return res.json({
              result: "success",
              message: `Email has been sent to ${ username }(${user.email}). Follow the instruction to reset your password.`
            });
          })
          .catch(err => {
