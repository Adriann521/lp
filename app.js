      ...
      if (err) {
        ...
        sgMail
          ...
          .then(response => {
            return res.json({
              result: "success",
              message: `Invitation has been sent to ${email.email}.`
            });
          })
          .catch(err => {
